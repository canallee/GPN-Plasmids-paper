...
%  Figure 4. Supplementary S1-S7 here renumber globally to S13-S19.
%======================================================================
...
Supplementary Figures~\ref{fig:supp-umap-feature}--\ref{fig:supp-umap-gc}
...
the final encoder layer, whereas the \secref{sec:origin} classifier is fitted
% TODO wording: the artifact reads "whereas the §3 classifier is fitted on
% blocks.60". Under unnumbered sectioning this renders as the section name.

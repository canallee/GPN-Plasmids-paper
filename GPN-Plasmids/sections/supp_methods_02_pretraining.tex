...
699,973 sequences distributed across 214,950 Plasmid Taxonomic Units (PTUs).
\cite{redondosalvo2020pathways} Sequences were used together with their
IMG/PR metadata, including GOLD ecosystem annotations,
...
proceeded on eight devices through step 295,000, then on five, and finally on
...
million windows per epoch, this corresponds to roughly 102 resampled epochs,

...
them (oriTfinder2
% TODO cite: oriTfinder2. Named in the origin artifact but that artifact
% ships no bibliography, and no entry exists in songlab.bib.
, OriV-Finder
% TODO cite: OriV-Finder. Same as above.
) are reference- and alignment-based: they recognize an origin by its
...
prediction on the plasmid sequences of the IMG/PR database. To learn from the

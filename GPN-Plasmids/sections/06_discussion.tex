...
Combining \model with Evo2-7B improved on either model alone, which is
consistent with the two carrying partly non-redundant predictive information,
though an ensemble gain is also consistent with variance reduction across
differently seeded probes.
% Hedge matched to the Results 2026-09-04. The Results say "consistent with"
% and this said "indicates". Distinguishing the two explanations needs a
% prediction-correlation or error-overlap measurement, which is not reported. Two
...
representative per PTU \cite{nguyen2024sequence}, so the two models saw different amounts of
...
% Corrected 2026-09-04: the Methods state that the pHTbeta ORF32 panel was NOT
% from the motif scan -- its boxes were placed by consensus substring match.
promoters were chosen as visually clean examples, three from a motif scan and
one placed by consensus substring match, and do not

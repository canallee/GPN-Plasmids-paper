...
%======================================================================
% PLACEHOLDER -- none of the three companion artifacts supplies Extended Data
% figures; every one of their supplementary panels is carried in the
% "Supplementary Figures" section below. The heading and the counter reset are
% kept so the slot exists if figures are promoted here later.

\beginextendeddata

\todo{No Extended Data figures yet.}
